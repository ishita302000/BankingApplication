...
namespace ATM.Services
{
    public class DbServices : IDbServices
    {
        ...
        public DbServices(BankContext bankContext, IMapper mapper, ICustomerServices accountService)
        {
            _mapper = mapper;
        ...
        public Bank CreateBank(string name, string address, string currencyCode)
        {
        ...
        public Transaction GetTransactionById(string txnId)
        {
            ...
            transaction = _bankContext.Transaction.FirstOrDefault(t => t.Id == txnId);
            if (transaction == null)
            {
